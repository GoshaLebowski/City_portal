...
<head>
    ...
    <title class="lng-title">Авторизация</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href=" " class="lng-enter">Войти</a></li>
    ...
    <div class="body-form">
        <main>
            <form name="logForm" onsubmit="return volidateForm()" action="./registration and authorization/authorization.php" method="post">
                <div class="headerText">
                    <h3 class="lng-title1">Вход</h3>
                </div>
                ...
                <div class="reg-btn">
                    <button class="lng-auth btn btn-primary btn-lg" type="submit">Войти</button>
                </div>
                <div class="error-php">
                    <?php
                        if ($_SESSION['message'] ?? '') {
    ...
    <!-- <script src="js/changeLangLog.js"></script> -->
